...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!empty($novo_cartao) && $novo_cartao !== $pessoa['qrcode']) {
            ...
            $novo_saldo = number_format($pessoa['saldo'] + (float)-3.00, 2);
            ...
            $stmt = $pdo->prepare("
                ...
                VALUES (?, ?, 'custo cartao', ?, ?, 'Custo Inicial Cartao', NOW())
                ");
                $stmt->execute([$id_pessoa, $custo_cartao, $pessoa['saldo'], $novo_saldo]);
